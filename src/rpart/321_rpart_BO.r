...
ksemilla_azar  <- 100189   #cambiar por la primer semilla
...
ArbolesCrossValidation  <- function( data, param, qfolds, pagrupa, semilla )
{
  ...
  ganancias  <- mcmapply( ArbolSimple, 
                          ...
                          SIMPLIFY= FALSE,
                          mc.cores= 12 )   #se puede subir a qfolds si posee Linux o Mac OS
...
setwd("./labo/exp/HT3210")   #Establezco el Working Directory DEL EXPERIMENTO
