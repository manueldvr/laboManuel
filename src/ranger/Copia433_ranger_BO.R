...
# num trees  2000-4000   F 3550 a 3800
# MTRY   4-20
# MINNODESIZE    400-500
# MAXDEPTH         7-12
#Estructura que define los hiperparámetros y sus rangos
hs  <- makeParamSet(
          makeIntegerParam("num.trees" ,        lower=  3550L, upper= 3800L),  #la letra L al final significa ENTERO
          makeIntegerParam("max.depth",         lower=    1L, upper=   14L),  # 0 significa profundidad infinita
          makeIntegerParam("min.node.size" ,    lower=    1450L, upper=  2000L),
          makeIntegerParam("mtry" ,             lower=    11L, upper=   13L))


ksemilla_azar  <- 100193  #Aqui poner la propia semilla
...
setwd("./labo/exp/HT4330/")   #Establezco el Working Directory DEL EXPERIMENTO

#en estos archivos quedan los resultados
kbayesiana  <- "HT433.RDATA"
klog        <- "HT433-F-grupo.txt"
